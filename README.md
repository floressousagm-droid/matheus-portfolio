...
componentes), Motion, D3 e Lucide React.
...
components/
  ...
  contact/               seção "Contato" (botões de e-mail, LinkedIn e GitHub)
...
| --- | --- | --- |
| Identidade | Nome, Cargo, E-mail | O e-mail é o contato principal na seção Contato e no rodapé |
...
As variáveis de ambiente necessárias são as do painel de edição — veja
"Habilitando o painel em produção".
...
e-mail, LinkedIn e GitHub), mas fica pronto no dado caso você queira
reintroduzi-lo em outro ponto do site.
